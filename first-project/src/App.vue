<template>
  <section>
    ...
    <Details :상품="상품" :제목누른거="제목누른거" :모달창열림="모달창열림"></Details>
...
export default {
  ...
  methods: {
    increase(){
      this.clickMe +=1; // 데이터를 가져다가 쓰고 싶으면 반드시 this 키워드 qnxdlrl
    }
  }
}
</script>
...
button.btn {width: 80px; height: 30px; background: crimson; border-radius: 10px; color: #fff; transition: all 0.5s;}
